...
input_file = "artists_blocks/artists_part_1.csv"
output_file = "artists_blocks/artists_part_1_with_genres.csv"

API_KEY = "YOUR KEY"  # <-- paste API key here (not Shared secret)
