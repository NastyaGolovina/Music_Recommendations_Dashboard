...
input_file = "artists_blocks/artists_part_5.csv"
output_file = "artists_result/artists_part_5_with_genres.csv"

API_KEY = "59231a400bbe110ce0d83a0251d30e3b"  # <-- paste API key here (not Shared secret)
